...
//    REQUIRE(c.genotype_db()->at(0)->aa_structure() == IntVector{0, 0, 0, 0, 0});
//    REQUIRE(c.genotype_db()->at(127)->aa_structure() == IntVector{1, 7, 1, 1, 1});
//
//    //
...
//    REQUIRE(c.preconfig_population_events().size() == 15);
//    REQUIRE(c.preconfig_population_events()[0]->time == 78);
//    REQUIRE(c.preconfig_population_events()[1]->time == 78);
//    REQUIRE(c.preconfig_population_events()[2]->time == 104);
//    REQUIRE(c.preconfig_population_events()[3]->time == 236);
//    REQUIRE(c.preconfig_population_events()[4]->time == 292);
//    REQUIRE(c.preconfig_population_events()[5]->time == 152);
//    REQUIRE(c.preconfig_population_events()[6]->time == 31);
//    REQUIRE(c.preconfig_population_events()[7]->time == 59);
//    REQUIRE(c.preconfig_population_events()[8]->time == 151);
//    REQUIRE(c.preconfig_population_events()[9]->time == 60);
//    REQUIRE(c.preconfig_population_events()[10]->time == 152);
//    REQUIRE(c.preconfig_population_events()[11]->time == 244);
//    REQUIRE(c.preconfig_population_events()[12]->time == 10957);
