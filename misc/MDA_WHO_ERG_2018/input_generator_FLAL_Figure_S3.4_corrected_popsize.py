...
stream = open('input_FLAL_40k_imp_no_itc_OZ_S3.4_v2.yml', 'r');
...
#switch_OZFQ_dates = ['2022/1/1' , '2022/1/1','2022/1/1','2022/1/1','2022/1/1']
...
for mda_round in number_MDA_round:
    for beta in betas:
        for _,itc in improved_tc.items():                
            ...
            output_filename = 'corrected_popsize/FigureS3.4/ONELOC_40k_%dRMDA_%s_OPPUNIFORM_FLAL_imp_OZ%s.yml'%(mda_round,pfpr_str,itc);
