...
switch_OZFQ_dates = ['2042/1/1' , '2022/1/15','2022/2/19','2022/3/26','2022/4/30']
...
for mda_round in number_MDA_round:
    for beta in betas:
        for _,itc in improved_tc.items():                
            ...
            output_filename = 'corrected_popsize/FigureS3.1/ONELOC_40k_%dRMDA_%s_OPPUNIFORM_FLAL_imp_OZ%s.yml'%(mda_round,pfpr_str,itc);
