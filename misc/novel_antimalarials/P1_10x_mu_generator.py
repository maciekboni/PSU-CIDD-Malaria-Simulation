...
stream = open('input_novel_antimalarials_10x_mu.yml', 'r');
            ...
            for tf, tf_str in tf_switch.items():
                for rf, rf_str in replacement_fractions.items():
                    for ec50, ec50_str in KAF_EC50s.items():
                        ...
                        output_filename = 'P1_10x_mu/NovelDrug_PFPR_%s_TC_%s_FL_%s_TF_%s_Q_%s_EC50_%s.yml'%( pfpr,tc_str, fl_str, tf_str, rf_str, ec50_str);
